 ...
 * @author doratt
 */
public class FrmPuntoFijo extends javax.swing.JFrame {
    ...
    public FrmPuntoFijo() {
        initComponents();
        modelo = new DefaultTableModel(new Object[]{"Iteración", "Xn", "G(xn)", "Error Aproximado"}, 0);
    ...
    private void btnPuntoFijoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPuntoFijoActionPerformed
        ...
        jTable1.setModel(pf.puntoFijo(Double.parseDouble(txtX1.getText()), Integer.parseInt(txtCifras.getText())));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPuntoFijo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPuntoFijo().setVisible(true);
            }
        });
    }
